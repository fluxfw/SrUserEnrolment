...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrUserEnrolment\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\SrUserEnrolment\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\SrUserEnrolment\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
