...
```json
  "pre-autoload-dump": [
    ...,
      "srag\\GeneratePluginInfosHelper\\SrUserEnrolment\\x\\GeneratePluginPhpAndXml::generatePluginPhpAndXml"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrUserEnrolment\\x\\GeneratePluginReadme::generatePluginReadme"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrUserEnrolment\\x\\UpdatePluginReadme::updatePluginReadme"
    ]
```
